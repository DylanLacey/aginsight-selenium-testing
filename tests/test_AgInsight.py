...
class TestAgInsight(BaseTest):
    ...
    # TODO: This test is removed until we can work out why the save button click is failing in Selenium
    ...
    # TODO: This test is removed, until we are on AgInsight 4x. Due to change in Basemap Gallery
